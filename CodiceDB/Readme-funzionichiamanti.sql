...
--inserire il PAN della carta di un conto corrente per renderla di tipo 'CartaDiCredito'
call upgrade_carta('1016088900391780');



--inserire il PAN della carta di un conto corrente per renderla di tipo 'CartaDiDebito'
call downgrade_carta('1016088900391780');



--ordine di inserimento per inserire i dati di una transazione di tipo Bonifico nella rispettiva tabella:
...
--ordine di inserimento per inserire i dati di una transazione di tipo Bonifico Istantaneo nella rispettiva tabella:
--(iban mittente, iban destinatario, importo, causale)
...
--ordine di inserimento per inserire i dati di un salvadanaio virtuale nella rispettiva tabella:
--(iban personale, nome salvadanaio, obiettivo monetario, descrizione salvadanaio)
call crea_salvadanaio('IT5171562771094677876062106', 'Vacanza estiva 2024', 1000, 'Risparmi per la vacanza estiva del 2024');
--salvadanaio alternativo: ('IT1118671947037826785928869', 'Regalo di nozze', 300, 'Regalo di nozze');



--inserire l'iban e il nome del salvadanaio per rimuoverlo dalla tabella
call rimuovi_salvadanaio('IT5171562771094677876062106', 'Vacanza estiva 2024');



--inserire l'iban personale, il nome del salvadanaio e la cifra che si vuole inviare ad esso
call invia_soldi_al_salvadanaio('IT5171562771094677876062106', 'Vacanza estiva 2024', 751);



--inserire l'iban personale, il nome del salvadanaio e la cifra che si vuole prendere da esso
