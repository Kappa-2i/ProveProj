...
public class CollectionPickViewGUI extends JFrame {
    ...
    //Icone
    ImageIcon iconAddCollection = new ImageIcon(HomeViewGUI.class.getResource("/IMG/add-folder.png"));
    ImageIcon iconHome = new ImageIcon(BankAccountPickViewGUI.class.getResource("/IMG/home.png"));
    ImageIcon iconUnina = new ImageIcon(HomeViewGUI.class.getResource("/IMG/unina.png"));
    ImageIcon iconTrash = new ImageIcon(HomeViewGUI.class.getResource("/IMG/trash.png"));
                ...
                if (collection.equals(controller.getCollections().get(controller.getCollections().size() - 1))) {
                    ...
                    createCollection.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e){
                            ...
                            if (result == JOptionPane.YES_OPTION) {
                                try {
                                    controller.addCollection(controller.getSelectedBankAccount(), nameCollectionField.getText(), descriptionCollectionArea.getText());
                                } catch (MyExc ex) {
