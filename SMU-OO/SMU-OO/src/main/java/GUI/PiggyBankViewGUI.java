...
public class PiggyBankViewGUI extends JFrame {
    ...
    ImageIcon iconAddPiggyBank = new ImageIcon(PiggyBankViewGUI.class.getResource("/IMG/addPiggyBank.png"));
    ...
    public PiggyBankViewGUI(Controller controller){
        ...
        for(PiggyBank piggyBank : controller.getPiggyBanks()){
            Object[] riga = {
                    piggyBank.getNamePiggyBank(),
                    piggyBank.getDescription(),
                    piggyBank.getTarget() + "€",
                    piggyBank.getSavingBalance() + "€",
                    piggyBank.getRemainingBalance() + "€",
                    piggyBank.getDateCreation()
            };
            modello.addRow(riga);
        }
